...
public static class RetroBatPaths
{
    ...
    public static string RuntimeLogRoot => Path.Combine(PluginRoot, ".log");
    public static string RuntimeTempRoot => Path.Combine(PluginRoot, ".temp");
    ...
    public static string PackageInstallerIndexRoot => Path.Combine(PluginRoot, "package-installer", "index");
    public static string RomPackInstallerIndexPath => Path.Combine(PackageInstallerIndexRoot, "index.json");
    public static string RomPackInstallerHashCachePath => Path.Combine(PackageInstallerIndexRoot, "package-hashes.json");
    public static string CollectionPackInstallerIndexPath => Path.Combine(PackageInstallerIndexRoot, "collections-index.json");
